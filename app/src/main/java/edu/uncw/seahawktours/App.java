...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        if (buildingBox.count() == 0) {
            ...
            initialBuildings.add(new Building("Chancellors Walk", R.string.Randall_url, R.drawable.randall, R.string.RandallCaption, R.string.RandallInfo));
            ...
            initialBuildings.add(new Building("Cultural Arts Building", R.string.Arts_url, R.drawable.arts, R.string.ArtsCaption, R.string.ArtsInfo));
